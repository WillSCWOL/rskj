...
public class ProofOfWorkRule implements BlockHeaderValidationRule, BlockValidationRule {
    ...
    public boolean isValid(BlockHeader header) {
        ...
        BigInteger bitcoinMergedMiningBlockHashBI = bitcoinMergedMiningBlock.getPoWHash().toBigInteger();
        ...
        * */
        ...
        //KCOIN COINBASE HAS VARIABLE SIZE BECAUSE OF MASTERNODE PAYMENTS
