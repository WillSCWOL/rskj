...
public class ConfigLoader {
    ...
    private static final String TESTNETDEV_RESOURCE_PATH = "config/testnetdev";
    ...
    private Config getNetworkDefaultConfig(Config userConfig) {
        if (userConfig.hasPath(SystemProperties.PROPERTY_BC_CONFIG_NAME)) {
            ...
            } else if (NodeCliFlags.NETWORK_TESTNETDEV.getName().equals(network)) {
                return ConfigFactory.load(TESTNETDEV_RESOURCE_PATH);
