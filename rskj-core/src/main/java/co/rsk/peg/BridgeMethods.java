...
public enum BridgeMethods {
    ...
    IS_AWAITING_SIGN_BY_FEDERATOR(
            CallTransaction.Function.fromSignature(
                    "isAwaitingSignByFederator",
                    new String[]{"bytes","bytes"},
                    new String[]{"bool"}
            ),
            23000L,
            Bridge.activeAndRetiringFederationOnly((BridgeMethodExecutorTyped) Bridge::isAwaitingSignByFederator, "isAwaitingSignByFederator")
    ),
    CLEAR_SIGNATURES(
            CallTransaction.Function.fromSignature(
                    "clearSignatures",
            ...
            70000L,
            Bridge.activeAndRetiringFederationOnly((BridgeMethodExecutorVoid) Bridge::clearSignatures, "clearSignatures")
    ),
    COMMIT_FEDERATION(
            CallTransaction.Function.fromSignature(
                    "commitFederation",
    ...
    REGISTER_BTC_TRANSACTION(
            CallTransaction.Function.fromSignature(
                    ...
                    new String[]{"bytes", "int", "bytes", "bytes", "int", "bytes"},
                    new String[]{}
            ),
            22000L,
