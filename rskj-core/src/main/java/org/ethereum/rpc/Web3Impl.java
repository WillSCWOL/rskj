...
public class Web3Impl implements Web3 {
    ...
    public BlockResult getBlockResult(Block b, boolean fullTx) {
        ...
        br.paidFees = b.getFeesPaidToMiner().toString();
    ...
    @Override
    public String[] personal_dumpPrivPubKeys(String address) throws Exception {
        return personalModule.dumpPrivPubKeys(address);
    }
